...
class App(ctk.CTk):
    def __init__(self):
        ...
        # =========== left frame ==============
        self.input_label = ctk.CTkLabel(master=self.frame_left, text="Input Text File", text_font=("Roboto Medium", 16),) # my machine can't work with "text_font" argument, using newer "font" argument instead 
